...
export const DESIGNLY_AGENT_REGISTRY: AgentCapability[] = [
  ...
  { id: "web-architect", name: "WEB ARCHITECT", role: "teljes weboldal információs architektúra és funkcionális struktúra specialist", capabilities: ["site-architecture","multi-page","navigation","user-flow","responsive"], source: "Designity" },
  { id: "ux-ui", name: "UX/UI AGENT", role: "webes élmény, komponensrendszer és interakció specialist", capabilities: ["ux","ui","components","interactions","accessibility","responsive"], source: "Designity" },
  { id: "seo-content", name: "SEO CONTENT AGENT", role: "weboldal tartalom, SEO és konverziós szöveg specialist", capabilities: ["seo","metadata","copy","headings","cta","conversion"], source: "Designity" },
  { id: "web-qa", name: "WEB QA AGENT", role: "funkcionális és reszponzív weboldal minőségbiztosítás", capabilities: ["web-qa","links","forms","responsive","accessibility","acceptance"], source: "Designity" },

...
VALUES (
  ...
  5000,
  5000,
  ARRAY['5,000 credits / month','5,000 projects','All export formats','Unlimited Brand Kits','Team collaboration','Priority support','API access','All premium features'],
  true,
  6
)
